...
public class AddSocketTimerActivity extends BaseActivity {
    @Bind(R.id.backRel)
    ...
    @Bind(R.id.activity_add_switch_timer)
    LinearLayout activityAddSwitchTimer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_socket_timer);
        ...
        switch (view.getId()) {
            ...
            case R.id.saveTimerRel:
                if (order > detailsTimeList.size()) {
                    Toast.makeText(AddSocketTimerActivity.this,"超出定时器最大数量，不能再添加",Toast.LENGTH_SHORT).show();
                }else {
                    save();
                }
                break;
...
//        Log.e("==temperature",detailsTimeList.get(order-1).getTemperature());
        ...
        x.http().request(HttpMethod.GET, params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                try {
                    ...
                    if ("1".equals(code)||"操作成功".equals(code)) {
                        ...
                        Toast.makeText(AddSocketTimerActivity.this,code,Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                Toast.makeText(AddSocketTimerActivity.this,"服务器连接失败，请重试",Toast.LENGTH_SHORT).show();
            }
