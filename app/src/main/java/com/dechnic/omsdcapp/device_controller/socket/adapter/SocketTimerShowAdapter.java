...
public class SocketTimerShowAdapter extends BaseAdapter{
    ...
    public SocketTimerShowAdapter(Context mContext, List<TimerEntity> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_socket_timer_list,null);
...
//        }
    ...
    class ViewHolder{
        TextView timeTv,timceTv,statusTv;
