...
public class TimerShowAdapter extends BaseAdapter {
    ...
    public TimerShowAdapter(Context mContext, List<TimerEntity> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_timer_list, null);
    ...
    public interface onSwitchListener {
        void onSwitchChanged(boolean status, String id, int order);
