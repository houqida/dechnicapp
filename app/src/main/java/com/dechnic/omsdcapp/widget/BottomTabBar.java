...
public class BottomTabBar extends LinearLayout{
    ...
    public void setBars(List<BottomBarEntity> bars) {
        init(bars);
    }
    ...
    public BottomTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSelectColor = typedArray.getColor(R.styleable.BottomTabBar_textSelectColor,Color.parseColor("#0085e3"));
     ...
     * @param bars
     */
    private void init(final List<BottomBarEntity> bars) {
     ...
     * @param position
     */
    public void select(int position, List<BottomBarEntity> bars) {
